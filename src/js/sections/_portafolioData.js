export const portafolioInfo = [
  ...
  },
  {
    ...
    repository: "https://github.com/Emarmota/YIGOVIA-TEAM",
    websiteUrl: null,
    description: `
  ...
  },
  {
    ...
    repository: "https://github.com/jehison98/houses-catalog",
  ...
  },
  {
    ...
    repository: "https://github.com/jehison98/img-network",
    websiteUrl: null,
    description: `
  ...
  },
  {
    ...
    repository: "https://github.com/jehison98/Portafolio-Copy",
    websiteUrl: "https://jehison98.github.io/portafolio-copy-build/",
    description: `
  ...
  },
  {
    id: 6,
    title: "Pokemon App",
    subtitle: "ReactJS, Redux, CSS, NodeJS, Express, PostgresSQL, Sequelize",
    imgUrl: "./assets/img/portafolio/pokemon-app.png",
    repository: "https://jehison98.github.io/JehisonGB/",
    websiteUrl: null,
    description: `Developmet of a SPA (single page aplication) usign React to the Front End, and Redux as stage management. 
    The styles in CSS was created by my without using a external libraries like Bootstrap. 
    The app cosume data from a external API (pokemon Api) and also consume data from postgres SQL. 
    The backend use Node JS as programming lenguage with express and use Sequelize to connect and cosume data more easy from postgres sql. 
    In this project I needed to add some extra functionalities like filters, sorts, show specific info from a specific pokemon, create a custom pokemon.`,
  },
  {
    id: 7,
    title: "My Portafolio",
    subtitle:
      "HTML, SASS, JavaScript, Bootstrap, Webpack, NodeJS, Express, NodeMailer",
